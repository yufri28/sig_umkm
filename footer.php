...
<footer class="bg-white text-center text-lg-start">
    ...
    <div class="container p-3">
        <div class="row justify-content-center">
            <div class="col-auto">
                <a href="https://wa.me/your_whatsapp_number" target="_blank" class="text-decoration-none me-4">
            ...
            <div class="col-auto">
                <a href="https://www.facebook.com/your_facebook_page" target="_blank" class="text-decoration-none me-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
