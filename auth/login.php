                        ...
                        <div class="card">
                            <div class="card-body py-5 px-md-5">
                                ...
                                <div class="col-12 d-flex justify-content-center mb-3">
                                    <img src="../assets/images/gereja.jpg" alt="" style="width: 200px; height: 200px;">
                                </div>
                                <form method="post" action="">
                                    ...
                                    <div class="form-outline mb-4">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="col-10">
                                                <input type="text" id="username" placeholder="USERNAME" required name="username" class="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-outline mb-4">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="col-10">
                                                <input type="password" id="password" placeholder="******" required name="password" class="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Submit button -->
