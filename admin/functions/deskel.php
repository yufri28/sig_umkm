...
class Deskel
{
    ...
    {
        return $this->db->query(
            "SELECT * FROM deskel WHERE id_deskel='$id'"
        );
    }

    public function add($nama_deskel)
    {
        if(!empty($nama_deskel)){
            ...
            $insert = $this->db->query(
                        "INSERT INTO deskel (id_deskel,nm_deskel) VALUES(0,'$nama_deskel')"
                        );
    ...
    public function update($data)
    {
        if(!empty($data)){
            ...
            $update = $this->db->query(
                        "UPDATE deskel SET nm_deskel = '$nama_deskel' WHERE id_deskel='$id_deskel'"
                        );
