    ...
    <form action="" method="post">
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="nama_deskel" name="nama_deskel" placeholder="Nama Desa/Kelurahan" value="<?= $data_cek['nm_deskel']; ?>" required>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <select name="id_kec" id="id_kec" class="form-control">
                        ...
                        <?php foreach ($data_kecamatan as $key => $kecamatan) : ?>
                            <option <?= $data_cek['id_kecamatan'] == $kecamatan['id_kec'] ? 'selected' : ''; ?> value="<?= $kecamatan['id_kec']; ?>"><?= $kecamatan['nm_kec']; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
