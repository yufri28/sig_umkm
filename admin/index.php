                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        ?>
                            ...
                            <li class="nav-item">
                                <a href="?page=data-ku" class="nav-link <?= isset($_GET['page']) ? ($_GET['page'] == 'data-ku' || $_GET['page'] == 'add-ku' || $_GET['page'] == 'edit-ku' || $_GET['page'] == 'view-ku' ? 'active' : '') : '' ?>">
                            ...
                            <li class="nav-item">
                                <a href="?page=data-faq" class="nav-link <?= isset($_GET['page']) ? ($_GET['page'] == 'data-faq' || $_GET['page'] == 'add-faq' || $_GET['page'] == 'edit-faq' || $_GET['page'] == 'view-faq' ? 'active' : '') : '' ?>">
                        ...
                        <li class="nav-item">
                            <a onclick="return confirm('Apakah anda yakin akan keluar ?')" href="../auth/logout.php" class="nav-link">
