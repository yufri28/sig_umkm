<?php
    ...
    if (isset($_POST['Ubah'])){
        $data = [
            'id_su' => htmlspecialchars($_GET['kode']),
            'nama_su' => htmlspecialchars($_POST['nama_su'])
        ];
        $Sektor->update($data);
    }
?>
    ...
    <form action="" method="post">
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="nama_su" name="nama_su" placeholder="Nama Sektor Usaha"
                        value="<?=$data_cek['nm_su'];?>" required>
                </div>
            </div>
        </div>
