        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    ...
                    <input type="text" class="form-control" id="pertanyaan" value="<?= $data_cek['pertanyaan']; ?>"
                        name="pertanyaan" placeholder="Masukkan pertanyaan" required>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Jawaban</label>
                <div class="col-sm-5">
                    <textarea class="form-control" name="jawaban" required id="jawaban" cols="30"
                        rows="10"><?= $data_cek['jawaban']; ?></textarea>
                </div>
            </div>
        </div>
